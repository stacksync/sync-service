...
public class MainRMISer {
	public static void main(String args[]) {
		try {
			...
			// PostgresqlDeviceDAORMISer postgresqlDeviceDAO = new
			// PostgresqlDeviceDAORMISer();
			// PostgresqlItemDAORMISer postgresqlItemDAO = new
			// PostgresqlItemDAORMISer();
			// PostgresqlItemVersionDaoRMISer postgresqlItemVersionDao = new
			// PostgresqlItemVersionDaoRMISer();
			PostgresqlUserDAORMISer postgresqlUserDAO = new PostgresqlUserDAORMISer();
			// PostgresqlWorkspaceDAORMISer postgresqlWorkspaceDAO = new
			// PostgresqlWorkspaceDAORMISer();
