 ...
 */
public class InfinispanDAOShardered implements InfinispanWorkspaceDAOShardered, InfinispanItemDAO, InfinispanItemVersionDAO, InfinispanUserDAO, InfinispanDeviceDAO, Serializable {

    private WorkspaceRMIShardered workspace;
    ...
    public InfinispanDAOShardered(AtomicObjectFactory factory) {
    ...
    public WorkspaceRMIShardered getById(UUID id) throws RemoteException {
        ...
        workspace = (WorkspaceRMIShardered) factory.getInstanceOf(WorkspaceRMIShardered.class, id.toString(), false, null, false);
        return workspace;
    ...
    public List<WorkspaceRMIShardered> getByUserId(UUID userId) throws RemoteException {
        ...
        List<WorkspaceRMIShardered> result = new ArrayList<WorkspaceRMIShardered>();
    ...
    public WorkspaceRMIShardered getDefaultWorkspaceByUserId(UUID userId) throws RemoteException {
        ...
        WorkspaceRMIShardered defaultWorkspace = null;
        for (UUID w : workspaces) {
            WorkspaceRMIShardered wspace = (WorkspaceRMIShardered) factory.getInstanceOf(WorkspaceRMIShardered.class, w.toString(), false, null, false);
            if (!wspace.isShared()) {
    ...
    @Override
    public void add(WorkspaceRMIShardered wspace) throws RemoteException {
        //Maybe it should be named create

        workspace = (WorkspaceRMIShardered) factory.getInstanceOf(WorkspaceRMIShardered.class, wspace.getId().toString(), false, null, false);
        workspace.setWorkspace(wspace);
        //factory.disposeInstanceOf(WorkspaceRMIShardered.class, wspace.getId().toString(), true);

    }

    @Override
    public void update(UserRMI usr, WorkspaceRMIShardered wspace) throws RemoteException {
        ...
        /*for (UUID w : list) {
         ...
         factory.disposeInstanceOf(WorkspaceRMIShardered.class, w.toString(), true);
         }
         }*/
    }
    ...
    public void deleteWorkspace(UUID id) throws RemoteException {
        ...
        //factory.disposeInstanceOf(WorkspaceRMIShardered.class, id.toString(), false);
    }

    @Override
    public void addUser(UserRMI usr, WorkspaceRMIShardered wspace) throws RemoteException {
    ...
    @Override
    public void deleteUser(UserRMI usr, WorkspaceRMIShardered wspace) throws RemoteException {
    ...
    public List<UserWorkspaceRMI> getMembersById(UUID wspaceId) throws RemoteException {
        ...
        workspace = (WorkspaceRMIShardered) factory.getInstanceOf(WorkspaceRMIShardered.class, wspaceId.toString(), false, null, false);
    ...
    public ItemRMI findById(Long id) throws RemoteException {
        ...
        item = (ItemRMI) factory.getInstanceOf(ItemRMI.class, id.toString(), false, null, false);
        return item;
    }
    ...
    public void add(ItemRMI item) throws RemoteException {
        ...
        factory.getInstanceOf(ItemRMI.class, item.getId().toString(), false, null, false);
    ...
    public void update(ItemRMI item) throws RemoteException {
        ...
        //factory.disposeInstanceOf(WorkspaceRMIShardered.class, workspace.getId().toString(), true);
    }
    ...
    private ItemMetadata addChildrenFromItemMetadata(ItemMetadata itemMetadata, Boolean includeDeleted) {
        ...
        try {
            item = findById(itemMetadata.getId());
        } catch (RemoteException ex) {
            Logger.getLogger(InfinispanDAOShardered.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void add(ItemVersionRMI itemVersion) throws RemoteException {
        ...
        item = findById(itemVersion.getItemId());
        if (item != null) {
    ...
    public void deleteUser(UUID id) throws RemoteException {
        ...
        for (UUID w : list) {
            workspace = (WorkspaceRMIShardered) factory.getInstanceOf(WorkspaceRMIShardered.class, w.toString(), false, null, false);
