...
public class WorkspaceRMIShardered implements Serializable{
    ...
    public WorkspaceRMIShardered() {
        this(null);
        this.itemIdCounter = 0;
        this.itemVersionIdCounter = 0;
    }

    public WorkspaceRMIShardered(UUID id) {
        this(id, 0, null, false, false);
    }

    public WorkspaceRMIShardered(UUID id, Integer latestRevision, UUID owner, boolean isShared, boolean isEncrypted) {
        this.id = id;
    ...
    public void setWorkspace(WorkspaceRMIShardered workspace) {
