...
public class DBBenchmark extends Thread {
	...
	// }
	//
	// public void createAndStoreMetadata(Workspace workspace, Device device,
	// int currentLevel, Item parent)
	...
	// }
	//
	// List<Item> objectsLevel = metadataGen.generateLevel(workspace, device,
	// parent);
	...
	// }
	//
	// System.out.println("***** " + name + " --> Stored objects: " +
	// objectsLevel.size() + " at level: " + currentLevel);
	// }
	//
	// @Override
	// public void run(){
	...
	//
	// try {
	// User user = new User(UUID.randomUUID(), "tester1", "tester1",
	// "AUTH_12312312", "a@a.a", 100, 0);
